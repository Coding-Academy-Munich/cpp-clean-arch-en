...
//
// - Open the project:
//   - `File` $\rightarrow$ `Open` $\rightarrow$ select `code/CMakeLists.txt` file
// - Select `Open as Project`
// - The targets are automatically detected
// - The configurations from `CMakePresets.json` can be selected in the settings
